...
<div class="container">
    <div class="row">
    <form class="col-lg-12" action="/ann/{{$ann_detail->ann_id}}" method="POST" style="margin-bottom:20px;">
            @csrf
            @method('PUT')
            <h2 style="margin-top:20px;">New Announcement</h2>
            <div class="form-group">
                <label for="title">Title：</label>
            <input type="text" value="{{$ann_detail->ann_title}}" class="form-control" id="title" name="title" placeholder="title">
            </div>
            <div class="form-group image" data-image="{{$ann_detail->ann_image}}">
            ...
            <div class="form-group">
                ...
                <textarea type='text' data-value="{{$ann_detail->ann_content}}" class="form-control" id="content" name="content" rows="3" placeholder="content"></textarea>
            </div>
